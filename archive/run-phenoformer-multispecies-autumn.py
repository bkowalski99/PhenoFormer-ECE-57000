...
for the autumn phenophases (Table 9). Simply uncomment the configuration that you would
...
target = "LC+NC"  # predict all leaf / needle colouring phases at the same time

## CONFIG 2 : Multi-species model + static site data (d)
